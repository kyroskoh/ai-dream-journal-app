...
export const LogoIcon: React.FC = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-purple-400">
        ...
        <path d="M12 6C9.13 6 6.79 8.04 6.18 10.75C7.29 9.68 8.93 9 10.5 9C12.43 9 14.1 10.13 14.82 11.66C15.99 11.13 17 10.03 17 8.5C17 7.12 15.88 6 14.5 6C13.54 6 12.7 6.53 12.25 7.25C12.17 7.09 12.09 6.94 12 6.78C12 6.52 12 6.26 12 6Z" fill="currentColor" fillOpacity="0.7"/>
    </svg>
);
